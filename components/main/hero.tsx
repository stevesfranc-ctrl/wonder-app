...
export const Hero = () => {
  return (
    <div id="about-me" className="relative flex-col md:flex-row !h-full w-full flex gap-10 md:gap-20 items-center pt-24 md:pt-8 justify-center overflow-hidden pb-10">
          ...
          >
            ...
            <div>
              ...
              <p className="mt-4 text-center text-sm text-gray-400 block md:hidden">
                <a href="/steves_franc_t_cv.pdf"
                  download>Cliquer pour avoir mon CV</a>
              </p>
            </div>
          </div>
